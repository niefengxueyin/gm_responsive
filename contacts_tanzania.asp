...
<!--#include file="common/includes/header.asp"-->
                         ...
                         <br/><br/><img src="images/callOutGraphics/weTrade5.jpg" width="714" height="133" alt="Charity" /><br/><h2>Tanzania</h2>
                         <br />
            ...
            <tr >
              ...
              <td width="11%" align="right" style="padding-top:3px;">&nbsp;</td>
                         ...
                         <table width="100%" border="0" cellspacing="0" cellpadding="0">
                           <tr>
                             <td width="33%"><strong>Physical  address</strong><br />
                               2nd Floor, FNB House, Ohio Street<br />
                               Dar es Salaam<br />
                               Tanzania</td>
                             ...
                             <td width="37%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                               <tr>
                                 ...
                                 <td width="67%">Keith  Blakeway</td>
                               </tr>
                               <tr>
                                 <td valign="top"><strong>Phone:</strong></td>
                                 <td>+255  768 989 049 <br /></td>
                               </tr>
                               <tr>
                         ...
                         <p><strong>Forex</strong><br />
                           ...
                           Bank of Tanzania  www.bot-tz.org<br />
                           Governor: B. Ndulu</p>
