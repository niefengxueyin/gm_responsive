...
<!--#include file="common/includes/header.asp"-->
                         ...
                         <br/><br/><img src="images/callOutGraphics/weTrade5.jpg" width="714" height="133" alt="Charity" /><br/><h2>Angola</h2>
                         <br />
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr >
              ...
              <td width="11%" align="right" style="padding-top:3px;">&nbsp;</td>
                         ...
                         National Bank of Angola  www.bna.ao<br />
                         Governor: J. Massano <br />
  <br />
