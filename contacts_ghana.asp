...
<!--#include file="common/includes/header.asp"-->
                         ...
                         <br/><br/><img src="images/callOutGraphics/weTrade5.jpg" width="714" height="133" alt="Charity" /><br/><h2>Ghana</h2>
                         <br />
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr >
              ...
              <td width="11%" align="right" style="padding-top:3px;">&nbsp;</td>
                         ...
                         <strong>Central bank</strong><br />
                         Bank of Ghana www.bog.gov.gh<br />
                         Governor: H.K. Wampah <br />
  <br />
  <strong>Ratings</strong><br />
                         Fitch: B+ (Negative outlook) <br />
                         S&amp;P: B
