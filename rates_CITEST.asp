...
<!--#include file="common/includes/header.asp"-->
	...
	currentYield7 = Rec("quote_mid3")
	if isnull(currentYield7) then
		currentYield7 = "&nbsp;"
	else
		currentYield7 = formatnumber(Rec("quote_mid3"),6)
		currentYield7 = currentYield7 * 100
		currentYield7 = formatnumber(currentYield7,4) + "%"
	end if
	...
	updatedTime2 = FormatDateTime(updatedTime,1)
	 ...
	 set Rec = nothing
           ...
           <% response.Write("<tr><td class=""borderBottomInside"" height=""25"">"&updatedTime&"</td><td class=""borderBottomInside"" height=""25"" align=""center"">"&currentRate&"</td><td class=""borderBottomInside"" height=""25"" align=""right"">"&currentYield7&"</td><td class=""borderBottomInside"" height=""25"" align=""right"">"&currentYield&"</td></tr>") %>
			</table>
	...
	if Rec.EOF then
		...
		yield = Rec("quote_mid2")
		
		if isnull(yield) then
			yield = "&nbsp;"
			else
		yield = formatnumber(yield,6)
		yield = yield * 100
